...
public class CanteenBeanTest {
	...
	/*
	 * ehemalige Anbindung an WebServices private static final String
	 * SOAP_ACTION =
	 * "http://ws.inf.fh-dortmund.de/CanteenBeanService/CanteenBean/"; private
	 * static final String METHOD_NAME = "getTastyMenusForWeek"; private static
	 * final String METHOD_NAME2 = "getTastySpecialsForWeek"; private static
	 * final String NAMESPACE = "http://canteen.fhapp.fhdo.de/"; private static
	 * final String URL =
	 * "http://ws.inf.fh-dortmund.de/CanteenBeanService/CanteenBean?xsd=1";
	 * 
	 * 
	 * public static JSONArray getMensaplan2JSON() { JSONObject jObject = null;
	 * try {
	 * 
	 ...
	 * androidHttpTransport.debug = true; androidHttpTransport.call(SOAP_ACTION,
	 * envelope);
	 * 
	 ...
	 * 
	 * JSONArray jArray = jObject.getJSONArray("MENUS"); Log.e("result",
	 * result.toString()); return jArray;
	 * 
	 * } catch (Exception e) { Log.e("a", e.toString()); }
	 * 
	 * return null; }
	 * 
	 * public static JSONArray getMensaplanJSON() { JSONObject jObject = null;
	 * JSONArray jArray = null; try {
	 * 
	 ...
	 * 
	 * Object result = (Object) envelope.getResponse();
	 * System.out.println(result.toString()); jObject = new
	 * JSONObject(result.toString());
	 * 
	 * System.out.println("Parsing!!!"); //
	 * System.out.println(jObject.toString()); // JSONObject arr =
	 * jObject.getJSONObject("MENUS");
	 * 
	 ...
	 * 
	 * 
	 * public static ArrayList<CanteenMenu> getMenusMensa() { JSONArray jArray =
	 * CanteenBeanTest.getMensaplanJSON(); JSONArray jArray2 =
	 * CanteenBeanTest.getMensaplan2JSON(); SimpleDateFormat sdfToDate = new
	 * SimpleDateFormat("dd.MM.yyyy"); ArrayList<CanteenMenu> menus = new
	 * ArrayList<CanteenMenu>(); try { for (int i = 0; i < jArray.length(); i++)
	 * {
	 * 
	 * JSONObject json_data = jArray.getJSONObject(i);
	 * 
	 * String title = json_data.getString("MENUTITLE"); String desc =
	 * json_data.getString("MENUDESC"); System.out.println(json_data);
	 * 
	 * Date dt = sdfToDate.parse(json_data.getString("DATE")); CanteenMenu cm =
	 * new CanteenMenu(title, desc, dt); Log.e("Test", json_data.toString());
	 * menus.add(cm);
	 * 
	 ...
	 * 
	 * String title = json_data.getString("MENUTITLE"); String desc =
	 * json_data.getString("MENUDESC"); CanteenMenu cm = new CanteenMenu(title,
	 * desc, null); Log.e("Test", json_data.toString()); menus.add(cm); }
	 * 
	 * } catch (Exception e) { Log.e("error", "Error while Parsing JSON"); }
	 * 
	 * return menus; }
	 */
