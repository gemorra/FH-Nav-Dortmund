...
public class SettingsManager {
	...
	public static void setLecture_details_groupletter(boolean lecture_details_groupletter, Context ctx) {
		checkPreferences(ctx);
	...
	public static void setLecture_details_lecturer(boolean lecture_details_lecturer, Context ctx) {
		checkPreferences(ctx);
	...
	public static void setLecture_details_type(boolean lecture_details_type, Context ctx) {
		checkPreferences(ctx);
